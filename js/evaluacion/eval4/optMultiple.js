        ...
        <section class="randomizeDOMClass lazy" id="pregunta${preguntas_aleatorias_indices[i]}" resultadoFinal="">
            ...
            <form class="cardPregunta clgreyl2 border1 shadow2">
                ...
                <div class="evaluateQuestionContainer">
                    <a style="text-transform: capitalize !important;" class='btn-large btnIndividualQuestion waves-effect waves-light border1 cl5 white-text' id="button_evaluation_${preguntas_aleatorias_indices[i]}" onclick="pregunta(${preguntas_aleatorias_indices[i]})">Revisar respuesta<i
